            ...
            <dialog id="${modalId}" style="padding: 0; border: none; border-radius: 8px; box-shadow: 0 4px 20px rgba(0,0,0,0.5); width: 300px; margin: auto; position: fixed; inset: 0;">
                <div style="background: var(--card-bg); color: var(--text-main); padding: 1.5rem;">
                    ...
                    <div style="display: flex; flex-direction: column; gap: 0.75rem;">
                        <button onclick="submitRSVP('YES')" class="btn" style="background-color: var(--accent); color: white; border: none; padding: 0.75rem; border-radius: 4px; cursor: pointer;">
                            Going (YES)
                        </button>
                        <button onclick="submitRSVP('NO')" class="btn" style="background-color: transparent; border: 1px solid var(--border-color); color: var(--text-main); padding: 0.75rem; border-radius: 4px; cursor: pointer;">
                            Not Going (NO)
                        </button>
                    </div>
