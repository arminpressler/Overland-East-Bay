...
class EBORsvpModule {
    ...
    constructor(container, tripId) {
        ...
        this.capacity = datasetCap ? parseInt(datasetCap, 10) : (this.tripId === 'TRIP_2026_09_11_Frazer_Flats_Basecamp' ? 13 : null);
    ...
    async submitRSVP(selectedStatus = 'Going') {
        ...
        // Gemini: changed 2026-08-18 - Pass capacity attribute in rsvpPayload
        const rsvpPayload = {
