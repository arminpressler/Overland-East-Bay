document.addEventListener('DOMContentLoaded', () => {
    ...
    <div class="footer-content">
        ...
        <div class="footer-links">
            ...
            <!-- Gemini: changed 2026-07-08 - Added Trip Agreement link -->
            <a href="${prefix}admin/group-trip-agreement.html">Trip Agreement</a>
            <span class="footer-separator">|</span>
            <!-- Gemini: changed 2026-07-29 - Added Trip Guidelines link -->
            <a href="${prefix}admin/trip-leader-guidelines.html">Trip Guidelines</a>
            <span class="footer-separator">|</span>
