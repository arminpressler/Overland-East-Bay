...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (!document.getElementById('ebo-search-css')) {
        ...
        searchCss.href = `${prefix}css/search.css?v=20260905131500`;
    ...
    if (!document.getElementById('ebo-search-modal')) {
        ...
        <dialog id="ebo-search-modal">
            ...
            <div class="search-modal-body">
                <div id="pagefind-modal-container"></div>
            </div>
        </dialog>
        `;
    ...
    /**
     * Opens the global search modal and lazy-loads Pagefind UI if needed.
     */
    window.openSearchModal = async () => {
        ...
        if (!pagefindLoaded) {
            ...
            // Initialize Pagefind UI widget
            if (window.PagefindUI && !document.querySelector('#pagefind-modal-container .pagefind-ui')) {
